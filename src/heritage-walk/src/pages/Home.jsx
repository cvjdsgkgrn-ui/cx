...
const styles = {
  ...
  title: { fontSize: 36, color: "#c4a35a", marginBottom: 6, textShadow: "0 0 30px rgba(196,163,90,0.3)" },
...
export default function Home() {
  ...
  const enterRandom = () => {
    ...
    localStorage.setItem("heritage-custom-tilemap", JSON.stringify(tiles))
    nav("/sandbox?map=custom")
  }

  return (
    <div style={styles.body}>
      <h1 style={styles.title}>遗产漫步</h1>
      <p style={styles.subtitle}>扬州名人故居 · AI 沉浸式游览</p>

      <div style={styles.cards}>
        <div onClick={() => nav("/sandbox")} style={styles.card}
          onMouseEnter={e => { e.currentTarget.style.borderColor = "#4a7c59"; e.currentTarget.style.background = "rgba(74,124,89,0.06)"; e.currentTarget.querySelector("h2").style.color = "#4a7c59" }}
          ...
          <h2 style={styles.h2}>故居宅院</h2>
          <p style={styles.p}>朱自清·汪曾祺故居家院</p>
        </div>

        <div onClick={enterRandom} style={styles.card}
          onMouseEnter={e => { e.currentTarget.style.borderColor = "#c4a35a"; e.currentTarget.style.background = "rgba(196,163,90,0.06)"; e.currentTarget.querySelector("h2").style.color = "#c4a35a" }}
          onMouseLeave={e => { e.currentTarget.style.borderColor = "rgba(255,255,255,0.08)"; e.currentTarget.style.background = "rgba(255,255,255,0.03)"; e.currentTarget.querySelector("h2").style.color = "#ccc" }}>
          <div style={styles.icon}>🎲</div>
          <h2 style={styles.h2}>随机场景</h2>
          <p style={styles.p}>随机生成宅院布局</p>
        </div>

        <div onClick={() => nav("/editor")} style={styles.card}
          onMouseEnter={e => { e.currentTarget.style.borderColor = "#6b8fbf"; e.currentTarget.style.background = "rgba(107,143,191,0.06)"; e.currentTarget.querySelector("h2").style.color = "#6b8fbf" }}
          onMouseLeave={e => { e.currentTarget.style.borderColor = "rgba(255,255,255,0.08)"; e.currentTarget.style.background = "rgba(255,255,255,0.03)"; e.currentTarget.querySelector("h2").style.color = "#ccc" }}>
          <div style={styles.icon}>🗺️</div>
      ...
      <div style={styles.footer}>扬州名人故居保护 · AI 沉浸式游览</div>
    </div>
  )
}
