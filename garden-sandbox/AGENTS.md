...
## 文件清单
- F:\cx\garden-sandbox\index.html - 主文件
- F:\cx\garden-sandbox\build_step1.py - HTML+CSS 构建
- F:\cx\garden-sandbox\build_step2.py - JS 第1部分
- F:\cx\garden-sandbox\build_step3.py - JS 第2部分
- F:\cx\garden-sandbox\build_step4.py - JS 第3部分
- F:\cx\garden-sandbox\fix_html.py - HTML 后处理
- F:\cx\garden-sandbox\rebuild.py - 旧版一次性构建（已废弃，勿用）
